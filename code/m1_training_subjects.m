...
info(1).raw_dir = fullfile(root,info(1).center_ID);
...
info(1).ecog(1).rereferencing = 'common_average';
...
info(1).segments(2).timewindows =  [323 500];
info(1).segments(2).location = [];

info(1).segments(3).electrodes = {'SMR'};
info(1).segments(3).channels = {'ecog1','ecog2','ecog3','ecog4','ecog5','ecog6'};
info(1).segments(3).timewindows =  [500 800];
info(1).segments(3).location = [];


% NEW SUBJECT
info(2).ID = 'N001';
info(2).center_ID = 'DBS4009';
info(2).raw_dir = fullfile(root,info(1).center_ID);
info(2).raw_filename = 'data_struct_raw_patient_BJ.mat';
info(2).disease = 'PD';
info(2).center = 'UPMC';
info(2).curator = 'Richardson';
info(2).age = 69;
info(2).sex = 'f';
